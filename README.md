...
Feel free to also browse around for other shaders, as long as it is compatible with game version 1.18.2 and Iris (mod we are using in lieu of Optifine, as Optifine is bug-prone).
